...
public class StreamsExample {
    ...
    public static void main(String[] args) {
		 /*
		 1- 	 Map<String,List<String>> studentMap = StudentDataBase.getAllStudents().stream()
				.collect(Collectors.toMap(Student::getName,Student::getActivities)); //<Map>
				System.out.println(studentMap);	
		 */
		 
		  /*
		  2-	Map<String,List<String>> studentMap = StudentDataBase.getAllStudents().stream()
		 ...
		 */
		  ...
		  /*
		 3- 	Predicate<Student> studentPredicate = (student -> student.getGradeLevel()>=3);
		 ...
		 */
		  /*
		 4-  	Predicate<Student> studentPredicate = (student -> student.getGradeLevel()>=3);
